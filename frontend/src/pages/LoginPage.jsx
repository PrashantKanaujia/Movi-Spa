...
export default function LoginPage({ onSignIn }) {
  ...
  return (
    <div className="min-h-screen grid place-items-center overflow-y-auto px-4 py-4 lg:h-screen lg:overflow-hidden">
      <div className="w-full max-w-[1200px] min-h-[calc(100vh-32px)] grid overflow-hidden rounded-[24px] bg-card shadow-[0_25px_60px_rgba(31,77,62,0.18)] lg:h-[calc(100vh-32px)] lg:grid-cols-2">
        <aside className="relative flex flex-col gap-4 bg-gradient-to-br from-primary to-accent px-6 py-5 text-white lg:gap-8 lg:px-10 lg:py-10">
          ...
          <div className="relative z-10 hidden space-y-4 lg:block">
          ...
          <div className="relative z-10 mt-auto hidden grid-cols-2 gap-3 lg:grid">
            {[
              {
                title: '99.9% reliable',
        ...
        <main className="grid bg-soft px-4 py-5 lg:h-full lg:grid-rows-[1fr_auto_auto] lg:items-center lg:gap-2 lg:px-10">
          <div className="w-full max-w-[460px] justify-self-center rounded-[20px] bg-white/95 p-5 shadow-soft lg:rounded-[24px] lg:p-6">
          ...
          <div className="mt-4 flex flex-wrap items-center justify-center gap-4 text-[10px] uppercase tracking-[1px] text-muted lg:mt-0 lg:gap-6">
